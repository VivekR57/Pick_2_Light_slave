...
void can_transmit(void)
{
	...
	TXB0D0 = read_internal_eeprom(0x00)+48;			/* DataByte 0 */
	TXB0D1 = read_internal_eeprom(0x01)+48;			/* DataByte 1 */
	TXB0D2 = read_internal_eeprom(0x02)+48;			/* DataByte 2 */
	TXB0D3 = read_internal_eeprom(0x03)+48;			/* DataByte 3 */
	TXB0D4 = read_internal_eeprom(0x04)+48;			/* DataByte 4 */
	TXB0D5 = read_internal_eeprom(0x05)+48;			/* DataByte 5 */
	TXB0D6 = read_internal_eeprom(0x06)+48;			/* DataByte 6 */
	TXB0D7 = read_internal_eeprom(0x07)+48;			/* DataByte 7 */
