...
void operation_mode(char key)
{
    ...
    if (flag == 0)
    {
        ...
        if (can_receive())
        {
            ...
            {
                flag = 1;
                can_u_st = ((can_payload[9] - '0') * 1000) +
                   ((can_payload[10] - '0') * 100) +
                   ((can_payload[11] - '0') * 10) +
                   (can_payload[12] - '0');
            }
        }
